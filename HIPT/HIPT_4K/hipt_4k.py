...
class HIPT_4K(torch.nn.Module):
	...
	def get_region_attention_heatmaps(self, x, offset=128, scale=4, alpha=0.5, cmap = cmap_map(lambda x: x/2 + 0.5, matplotlib.cm.jet), threshold=None, output_dir=None, fname=None):
		r"""
		...
		#cmap = cmap_map(lambda x: x/2 + 0.1, matplotlib.cm.jet)
		...
		for i in range(6):
			score256_1 = concat_scores256(a256_1[:,i,:,:], h_256, w_256, size=(w_s//w_256,h_s//h_256)) # these lines are bugged
			score256_2 = concat_scores256(a256_2[:,i,:,:], h_256, w_256, size=(w_s//w_256,h_s//h_256)) # these lines are bugged
			new_score256_2 = np.zeros_like(score256_2)
