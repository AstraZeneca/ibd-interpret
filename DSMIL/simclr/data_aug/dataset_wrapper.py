...
class DataSetWrapper(object):
    ...
    def __init__(self, batch_size, num_workers, valid_size, input_shape, s, csv):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = Dataset(csv_file=self.csv, transform=SimCLRDataTransform(data_augment))
